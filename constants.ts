...
export const BRICK_PROPERTIES: Record<BrickType, { color: string; maxHp: number; points: number }> = {
    ...
    [BrickType.QuantumFlux]: { color: 'bg-purple-600', maxHp: 8, points: 250 },
    [BrickType.Superposition]: { color: 'bg-violet-500', maxHp: 9, points: 270 },
    [BrickType.Entangled]: { color: 'bg-cyan-500', maxHp: 10, points: 295 },
    [BrickType.WaveFunction]: { color: 'bg-purple-400', maxHp: 11, points: 320 },
    [BrickType.Observer]: { color: 'bg-indigo-500', maxHp: 12, points: 350 },
    [BrickType.Uncertainty]: { color: 'bg-fuchsia-600', maxHp: 14, points: 380 },
    [BrickType.QuantumSingularityBoss]: { color: 'bg-gradient-to-r from-purple-700 via-cyan-500 to-violet-700', maxHp: 800, points: 55000 },
    // World 22 - Ancient Ruins
    [BrickType.RuneStone]: { color: 'bg-amber-600', maxHp: 8, points: 250 },
    [BrickType.AncientGolem]: { color: 'bg-stone-600', maxHp: 9, points: 270 },
    [BrickType.Sphinx]: { color: 'bg-yellow-700', maxHp: 10, points: 295 },
    [BrickType.Anubis]: { color: 'bg-amber-800', maxHp: 11, points: 320 },
    [BrickType.AncientMummy]: { color: 'bg-yellow-900', maxHp: 12, points: 350 },
    [BrickType.Hieroglyph]: { color: 'bg-orange-700', maxHp: 14, points: 380 },
    [BrickType.AncientOneBoss]: { color: 'bg-gradient-to-r from-amber-700 via-yellow-600 to-orange-700', maxHp: 810, points: 56000 },
    // World 23 - Plague Lands
    [BrickType.Infected]: { color: 'bg-lime-600', maxHp: 8, points: 250 },
    [BrickType.Carrier]: { color: 'bg-green-700', maxHp: 9, points: 270 },
    [BrickType.Diseased]: { color: 'bg-emerald-800', maxHp: 10, points: 295 },
    [BrickType.Plaguebearer]: { color: 'bg-green-900', maxHp: 11, points: 320 },
    [BrickType.Quarantine]: { color: 'bg-teal-700', maxHp: 12, points: 350 },
    [BrickType.Epidemic]: { color: 'bg-lime-800', maxHp: 14, points: 380 },
    [BrickType.PlagueDoctorBoss]: { color: 'bg-gradient-to-r from-green-900 via-lime-700 to-emerald-800', maxHp: 820, points: 57000 },
    // World 24 - Lightning Realm
    [BrickType.Spark]: { color: 'bg-yellow-300', maxHp: 8, points: 250 },
    [BrickType.Charge]: { color: 'bg-yellow-400', maxHp: 9, points: 270 },
    [BrickType.Static]: { color: 'bg-amber-400', maxHp: 10, points: 295 },
    [BrickType.Voltage]: { color: 'bg-yellow-500', maxHp: 11, points: 320 },
    [BrickType.Conductor]: { color: 'bg-amber-500', maxHp: 12, points: 350 },
    [BrickType.Thunderbolt]: { color: 'bg-yellow-600', maxHp: 14, points: 380 },
    [BrickType.LightningGodBoss]: { color: 'bg-gradient-to-r from-yellow-400 via-amber-300 to-yellow-600', maxHp: 830, points: 58000 },
    // World 25 - Blood Moon
    [BrickType.Vampire]: { color: 'bg-red-800', maxHp: 8, points: 250 },
    [BrickType.Werewolf]: { color: 'bg-stone-700', maxHp: 9, points: 270 },
    [BrickType.Ghoul]: { color: 'bg-gray-700', maxHp: 10, points: 295 },
    [BrickType.Banshee]: { color: 'bg-slate-800', maxHp: 11, points: 320 },
    [BrickType.Reaper]: { color: 'bg-gray-900', maxHp: 12, points: 350 },
    [BrickType.Lich]: { color: 'bg-purple-800', maxHp: 14, points: 380 },
    [BrickType.BloodLordBoss]: { color: 'bg-gradient-to-r from-red-950 via-red-800 to-gray-900', maxHp: 840, points: 59000 },
    // World 26 - Machine Core
    [BrickType.Nanobot]: { color: 'bg-slate-400', maxHp: 8, points: 250 },
    [BrickType.Automaton]: { color: 'bg-gray-500', maxHp: 9, points: 270 },
    [BrickType.Mainframe]: { color: 'bg-zinc-600', maxHp: 10, points: 295 },
    [BrickType.Protocol]: { color: 'bg-slate-600', maxHp: 11, points: 320 },
    [BrickType.Firewall]: { color: 'bg-gray-700', maxHp: 12, points: 350 },
    [BrickType.Encryption]: { color: 'bg-zinc-800', maxHp: 14, points: 380 },
    [BrickType.CoreAIBoss]: { color: 'bg-gradient-to-r from-slate-700 via-zinc-600 to-gray-700', maxHp: 845, points: 60000 },
    // World 27 - Spirit Realm
    [BrickType.Ghost]: { color: 'bg-slate-200', maxHp: 8, points: 250 },
    [BrickType.Poltergeist]: { color: 'bg-gray-300', maxHp: 9, points: 270 },
    [BrickType.Spirit]: { color: 'bg-slate-300', maxHp: 10, points: 295 },
    [BrickType.Haunt]: { color: 'bg-gray-400', maxHp: 11, points: 320 },
    [BrickType.Ectoplasm]: { color: 'bg-cyan-200', maxHp: 12, points: 350 },
    [BrickType.Possession]: { color: 'bg-purple-300', maxHp: 14, points: 380 },
    [BrickType.SpiritKingBoss]: { color: 'bg-gradient-to-r from-white via-cyan-200 to-purple-300', maxHp: 850, points: 61000 },
    // World 28 - Dragon's Domain
    [BrickType.Wyvern]: { color: 'bg-orange-600', maxHp: 8, points: 250 },
    [BrickType.Drake]: { color: 'bg-red-600', maxHp: 9, points: 270 },
    [BrickType.Wyrm]: { color: 'bg-orange-700', maxHp: 10, points: 295 },
    [BrickType.Serpent]: { color: 'bg-red-700', maxHp: 11, points: 320 },
    [BrickType.Dragon]: { color: 'bg-orange-800', maxHp: 12, points: 350 },
    [BrickType.ElderDragon]: { color: 'bg-amber-800', maxHp: 14, points: 380 },
    [BrickType.DragonEmperorBoss]: { color: 'bg-gradient-to-r from-red-700 via-orange-600 to-amber-500', maxHp: 850, points: 62000 },
    // World 29 - Multiverse Nexus
    [BrickType.Alternate]: { color: 'bg-gradient-to-r from-red-500 to-orange-500', maxHp: 8, points: 250 },
    [BrickType.Parallel]: { color: 'bg-gradient-to-r from-yellow-500 to-green-500', maxHp: 9, points: 270 },
    [BrickType.Divergent]: { color: 'bg-gradient-to-r from-green-500 to-cyan-500', maxHp: 10, points: 295 },
    [BrickType.Convergence]: { color: 'bg-gradient-to-r from-cyan-500 to-blue-500', maxHp: 11, points: 320 },
    [BrickType.Dimensional]: { color: 'bg-gradient-to-r from-blue-500 to-purple-500', maxHp: 12, points: 350 },
    [BrickType.Multiverse]: { color: 'bg-gradient-to-r from-purple-500 to-pink-500', maxHp: 14, points: 380 },
    [BrickType.NexusEntityBoss]: { color: 'bg-gradient-to-r from-red-500 via-green-500 via-blue-500 to-purple-500', maxHp: 850, points: 63000 },
    // World 30 - The Absolute End
    [BrickType.Omega]: { color: 'bg-gray-950', maxHp: 8, points: 250 },
    [BrickType.Alpha]: { color: 'bg-zinc-900', maxHp: 9, points: 270 },
    [BrickType.EndEternal]: { color: 'bg-slate-900', maxHp: 10, points: 295 },
    [BrickType.Infinite]: { color: 'bg-gray-900', maxHp: 11, points: 320 },
    [BrickType.EndAbsolute]: { color: 'bg-zinc-950', maxHp: 12, points: 350 },
    [BrickType.Perfection]: { color: 'bg-white', maxHp: 14, points: 380 },
    [BrickType.TheEndBoss]: { color: 'bg-gradient-to-r from-black via-white to-black', maxHp: 850, points: 65000 },
    // Catalyst Bricks
